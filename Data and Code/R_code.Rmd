...
######Power Curve for Frequency x Agency Interaction
SCurve1<-powerCurve(C1_m4, fixed("agentagent 2:frequencyBoth agents frequent", "z"),
                    along = "participant",
...
######Power Curve for Frequency x Agency Interaction
SCurve1<-powerCurve(E1_m4, fixed("agentagent 2:frequencyBoth agents frequent", "z"),
                    along = "participant",
                    breaks = c(20,40,60,80),
                    nsim=100,alpha=.045, progress=FALSE)
plot(SCurve1)
...
######Power Curve for Normality x Knowledge Interaction
SCurve1<-powerCurve(E3_m4, fixed("agentAgent 2: abnormal:knowledgeNo Knowledge", "z"),
                    along = "participant",
                    breaks = c(20,40,60,80),
                    nsim=100,alpha=.045, progress=FALSE)
plot(SCurve1)
...
######Power Curve for Normality x Agent Interaction
SCurve1<-powerCurve(C3_m4, fixed("agentAgent 2: abnormal:knowledgeNo Knowledge", "z"),
                    along = "participant",
                    breaks = c(20,40,60,80),
                    nsim=100,alpha=.045, progress=FALSE)
plot(SCurve1)
