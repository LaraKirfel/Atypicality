...
##Effect of frequency
anova(C1_m1,C1_m3)
r.squaredGLMM(C1_m2) #effect size for full model
r.squaredGLMM(C1_m3)[2] - r.squaredGLMM(C1_m1)[2] #effect size for factor only

##Effect of agent
anova(C1_m2,C1_m3)
r.squaredGLMM(C1_m1) #effect size for full model
r.squaredGLMM(C1_m3)[2] - r.squaredGLMM(C1_m2)[2] #effect size for factor only

##Interaction of frequency and agent
anova(C1_m3,C1_m4)
r.squaredGLMM(C1_m4)#effect size for full model
r.squaredGLMM(C1_m4)[2] - r.squaredGLMM(C1_m3)[2]  #effect size for factor only

##Three way interaction with scenario
anova(C1_m4,C1_m5)
r.squaredGLMM(C1_m5)#effect size for full model
r.squaredGLMM(C1_m5)[2] - r.squaredGLMM(C1_m4)[2]#effect size for factor only

##Test for agents in 'both frequent' condition
C1_t1 <- lmer(cause_rating ~ (1|participant), df.exp1_long[df.exp1_long$frequency=="Both agents frequent",], REML=F)
C1_t2 <- lmer(cause_rating ~ agent + (1 | participant), df.exp1_long[df.exp1_long$frequency=="Both agents frequent",], REML=F)
anova(C1_t1,C1_t2)

##Test for agents in 'one frequent' condition
C1_t3 <- lmer(cause_rating ~ (1|participant), data=df.exp1_long[df.exp1_long$frequency=="Agent 2 infrequent",])
C1_t4 <- lmer(cause_rating ~ agent + (1|participant), df.exp1_long[df.exp1_long$frequency=="Agent 2 infrequent",])
anova(C1_t3,C1_t4)

###Observed Power analysis
powerSim(C1_m5,fixed("agentagent 2", "z"), alpha=0.045, nsim = 50) #Effect "agent"
powerSim(C1_m5,fixed("frequencyBoth agents frequent", "z"), alpha=0.045, nsim = 50) # Effect "Frequency""
powerSim(C1_m5,fixed("frequencyBoth agents frequent:agentagent 2", "z"), alpha=0.045, nsim = 50) #Interaction "Frequency x Agent"" 
...
r.squaredGLMM(E1_m3)[2] - r.squaredGLMM(E1_m2)[2] #effect size for factor only

##Effect of frequency
anova(E1_m1,E1_m3)
r.squaredGLMM(E1_m2)
r.squaredGLMM(E1_m3)[2] - r.squaredGLMM(E1_m1)[2]


##Interaction of frequency and agent
anova(E1_m3,E1_m4)
r.squaredGLMM(E1_m4)
r.squaredGLMM(E1_m4)[2] - r.squaredGLMM(E1_m3)[2]


##Interaction scenario x frequency x agent
anova(E1_m4,E1_m5)
r.squaredGLMM(E1_m5)
r.squaredGLMM(E1_m5)[2] - r.squaredGLMM(E1_m4)[2]


##Test for `agent' in 'both frequent' condition
E1_t1 <- lmer(expect_rating ~ (1|participant), df.exp1_long[df.exp1_long$frequency=="Both agents frequent",], REML=F)
E1_t2 <- lmer(expect_rating ~ agent + (1 | participant), df.exp1_long[df.exp1_long$frequency=="Both agents frequent",], REML=F)
anova(E1_t1,E1_t2)

##Test for `agent' in 'one frequent' condition
E1_t3 <- lmer(expect_rating ~ (1|participant), data=df.exp1_long[df.exp1_long$frequency=="Agent 2 infrequent",], REML=F)
E1_t4 <- lmer(expect_rating ~ agent + (1|participant), df.exp1_long[df.exp1_long$frequency=="Agent 2 infrequent",], REML=F)
anova(E1_t3,E1_t4)
...
#####Power Analysis
powerSim(E1_m5,fixed("agentagent 2", "z"), alpha=0.045, nsim = 50) #Effect "agent"
powerSim(E1_m5,fixed("frequencyBoth agents frequent", "z"), alpha=0.045, nsim = 50) # Effect "Frequency""
powerSim(E1_m5,fixed("frequencyBoth agents frequent:agentagent 2", "z"), alpha=0.045, nsim = 50) #Interaction "Frequency x Agent"
...
Fig1a <- ggplot(df.exp1_long, aes(x=factor(frequency, levels=level_order), cause_rating, fill=agent)) +
...
#Save plot
ggsave(Fig1b, file="Fig1b.pdf", dpi=400, height = 6, width = 8)
```
...
anova(C2_m1,C2_m3)
r.squaredGLMM(C2_m2)
r.squaredGLMM(C2_m3)[2] - r.squaredGLMM(C2_m1)[2]

##Effect of frequency
anova(C2_m2,C2_m3)
r.squaredGLMM(C2_m1)
r.squaredGLMM(C2_m3)[2] - r.squaredGLMM(C2_m2)[2]
...
anova(C2_m4,C2_m5)
r.squaredGLMM(C2_m4)
r.squaredGLMM(C2_m4)[2] - r.squaredGLMM(C2_m3)[2]

####Power Analysis
#f2 obtained from Rc2 in Experiment 1
pwr.f2.test(u = 2, v = 130 - 2 - 1, f2 = 0.11/(1 - 0.11), sig.level = 0.05)
...
anova(E2_m1,E2_m3)
r.squaredGLMM(E2_m2)
r.squaredGLMM(E2_m3)[2] - r.squaredGLMM(E2_m1)[2]

##Effect of frequency
anova(E2_m2,E2_m3)
r.squaredGLMM(E2_m1)
r.squaredGLMM(E2_m3)[2] - r.squaredGLMM(E2_m2)[2]


##Interaction of frequency and agent
anova(E2_m3,E2_m4)
r.squaredGLMM(E2_m4)
r.squaredGLMM(E2_m4)[2] - r.squaredGLMM(E2_m3)[2]
...
##Test for agents in 'one frequent' condition
E2_t3 <- lmer(expect_rating ~ (1|participant), data=df.exp2_long[df.exp2_long$frequency=="Agent 2 infrequent",], REML=F)
E2_t4 <- lmer(expect_rating ~ agent + (1|participant), df.exp2_long[df.exp2_long$frequency=="Agent 2 infrequent",], REML=F)
anova(E2_t3,E2_t4)
...
####Power Analysis
#f2 obtained from Exp 1
pwr.f2.test(u = 2, v = 130 - 2 - 1, f2 = 0.18/(1 - 0.18), sig.level = 0.05)
...
#Save plot
ggsave(Fig2b, file="Fig2b.pdf", dpi=400, height = 6, width = 8)
```
...
anova(E3_m3,E3_m4)
r.squaredGLMM(E3_m4)[2] - r.squaredGLMM(E3_m3)[2]
...
##Test for agent in 'knowlege' condition
...
##Test for agent in 'no knowlege' condition
...
###Power analysis
powerSim(E3_m5,fixed("agentNormal Agent", "z"), alpha=0.045, nsim = 50) #Effect "agent"
powerSim(E3_m5,fixed("knowledgeNo Knowledge", "z"), alpha=0.045, nsim = 50) # Effect "Knowledge""
powerSim(E3_m5,fixed("agentNormal Agent:knowledgeNo Knowledge", "z"), alpha=0.045, nsim = 50) #Interaction "Knowledge x Agent" 
###Primary analysis
...
##Effect of agent
anova(C3_m2,C3_m3)
r.squaredGLMM(C3_m3)[2] - r.squaredGLMM(C3_m2)[2]

##Effect of knowledge
anova(C3_m1,C3_m3)
r.squaredGLMM(C3_m3)[2] - r.squaredGLMM(C3_m1)[2]

##Interaction of knowledge and agent
anova(C3_m3,C3_m4)
r.squaredGLMM(C3_m4)[2] - r.squaredGLMM(C3_m3)[2]

##Test for agent in 'knowlege' condition
C3_t3 <- lmer(cause_rating ~ (1|participant), data=df.exp3_long[df.exp3_long$knowledge=="Knowledge",], REML=F)
C3_t4 <- lmer(cause_rating ~ agent + (1|participant), df.exp3_long[df.exp3_long$knowledge=="Knowledge",], REML=F)
anova(C3_t3,C3_t4)

##Test for agent in 'no knowlege' condition
C3_t5 <- lmer(cause_rating ~ (1|participant), data=df.exp3_long[df.exp3_long$knowledge=="No Knowledge",], REML=F)
C3_t6 <- lmer(cause_rating ~ agent + (1|participant), df.exp3_long[df.exp3_long$knowledge=="No Knowledge",], REML=F)
anova(C3_t5,C3_t6)

##Three way interaction with scenario
anova(C3_m4,C3_m5)
r.squaredGLMM(C3_m5)[2] - r.squaredGLMM(C3_m4)[2]

###Power analysis
powerSim(C3_m5,fixed("agentNormal Agent", "z"), alpha=0.045, nsim = 50) #Effect "agent"
powerSim(C3_m5,fixed("agentNormal Agent:knowledgeNo Knowledge", "z"), alpha=0.045, nsim = 50) #Interaction "Knowledge x Agent"
...
df.exp3_long2 %>% 
 ...
 mutate(agent =factor(agent,levels=c( "Normal Agent", "Abnormal Agent"))) %>% 
 mutate(ratingtype =factor(ratingtype,levels=c( "expect_rating", "cause_rating"))) %>% 
 mutate(ratingtype =recode(ratingtype,
                            "expect_rating"= "Expectation Rating",
                            "cause_rating"= "Causal Rating"))
...
Knowledge <- df.exp3_long2 %>% 
  ...
  coord_cartesian(ylim = c(1,7.5)) +
  scale_y_continuous(breaks = seq(0, 7, by=1))+
  scale_x_discrete(labels=c("Normal Agent", "Abnormal Agent")) +
  stat_summary(fun.y = mean, geom = "bar", position = "dodge", colour = "black", alpha=0.6) +
  ...
  scale_fill_manual(values=Palette, labels=c("Normal Agent", "Abnormal Agent", "Normal Agent", "Abnormal Agent"))+
...
NoKnowledge <- df.exp3_long2 %>% 
  ...
  colour= "black")+
  facet_grid(.~ratingtype, scales = "free")+
  scale_fill_manual(values=Palette, name='Agent', labels=c("Normal Agent", "Abnormal Agent", "Normal Agent", "Abnormal Agent"))+
  labs( y="Agreement Rating")+
  theme_bw()+
  myTheme+
  theme(legend.position= "none")+
...
### save plot
ggsave(Fig3, file="Fig3.pdf", dpi=400, height = 8, width = 8)
...
##Effect of Knowledge
anova(E4_m1,E4_m3)
r.squaredGLMM(E4_m3)[1] - r.squaredGLMM(E4_m1)[1]

##Interaction of knowledge and agent
anova(E4_m3,E4_m4)
r.squaredGLMM(E4_m4)[1] - r.squaredGLMM(E4_m3)[1]

##Three way interaction scenario x knowledge x agent
anova(E4_m4,E4_m5)

#Test for agents in 'Knowledge' condition
E4_t1 <- lmer(exp_other ~ (1|participant), data=df.exp4_long[df.exp4_long$knowledge=="Knowledge",], REML=F)
E4_t2 <- lmer(exp_other ~ agent + (1|participant), df.exp4_long[df.exp4_long$knowledge=="Knowledge",], REML=F)
anova(E4_t1,E4_t2)

#Test for agents in 'No Knowledge' condition
E4_t3 <- lmer(exp_other ~ (1|participant), data=df.exp4_long[df.exp4_long$knowledge=="No Knowledge",], REML=F)
E4_t4 <- lmer(exp_other ~ agent + (1|participant), df.exp4_long[df.exp4_long$knowledge=="No Knowledge",], REML=F)
anova(E4_t3,E4_t4)

###Overall analysis
lmerTest::lmer(exp_other ~ knowledge*agent*scenario + (1 | participant), df.exp4_long)%>% summary()
...
##Effect of Knowledge
anova(Ex4_m1,Ex4_m3)
r.squaredGLMM(Ex4_m3)[1] - r.squaredGLMM(Ex4_m1)[1]

##Effect of Agent
anova(Ex4_m3,Ex4_m2)
r.squaredGLMM(Ex4_m3)[1] - r.squaredGLMM(Ex4_m2)[1]

##Interaction of knowledge and agent
anova(Ex4_m4,Ex4_m3)
r.squaredGLMM(Ex4_m4)[1] - r.squaredGLMM(Ex4_m3)[1]

##Three way interaction scenario x knowledge x agent
anova(Ex4_m5,Ex4_m4)
r.squaredGLMM(Ex4_m5)[1] - r.squaredGLMM(Ex4_m4)[1]


#Test for agents in 'Knowledge' condition
Ex4_t1 <- lmer(exp_outcome ~ (1|participant), data=df.exp4_long[df.exp4_long$knowledge=="Knowledge",], REML=F)
Ex4_t2 <- lmer(exp_outcome ~ agent + (1|participant), df.exp4_long[df.exp4_long$knowledge=="Knowledge",], REML=F)
anova(Ex4_t1,Ex4_t2)

#Test for agents in 'No Knowledge' condition
Ex4_t3 <- lmer(exp_outcome ~ (1|participant), data=df.exp4_long[df.exp4_long$knowledge=="No Knowledge",], REML=F)
Ex4_t4 <- lmer(exp_outcome ~ agent + (1|participant), df.exp4_long[df.exp4_long$knowledge=="No Knowledge",], REML=F)
anova(Ex4_t3,Ex4_t4)
...
##Effect of Knowledge
anova(M4_m1,M4_m3)
r.squaredGLMM(M4_m3)[1] - r.squaredGLMM(M4_m1)[1]

##Effect of Agent
anova(M4_m3,M4_m2)
r.squaredGLMM(M4_m3)[1] - r.squaredGLMM(M4_m2)[1]

##Interaction of knowledge and agent
anova(M4_m3,M4_m4)
r.squaredGLMM(M4_m4)[1] - r.squaredGLMM(M4_m3)[1]

##Three way interaction with scenario
anova(M4_m5,M4_m4)
r.squaredGLMM(M4_m5)[1] - r.squaredGLMM(M4_m4)[1]

#Test for agents in 'Knowledge' condition
M4_t1 <- lmer(mental_state ~ (1|participant), data=df.exp4_long[df.exp4_long$knowledge=="Knowledge",], REML=F)
M4_t2 <- lmer(mental_state ~ agent + (1|participant), df.exp4_long[df.exp4_long$knowledge=="Knowledge",], REML=F)
anova(M4_t1,M4_t2)

#Test for agents in 'No Knowledge' condition
M4_t3 <- lmer(mental_state ~ (1|participant), data=df.exp4_long[df.exp4_long$knowledge=="No Knowledge",], REML=F)
M4_t4 <- lmer(mental_state ~ agent + (1|participant), df.exp4_long[df.exp4_long$knowledge=="No Knowledge",], REML=F)
anova(M4_t3,M4_t4)

### T Test
t.test(mental_state ~ agent, data=df.exp4_long[df.exp4_long$knowledge=="Knowledge",], paired = F)
t.test(mental_state ~ agent, data=df.exp4_long[df.exp4_long$knowledge=="No Knowledge",], paired = F)
...
#save plot
ggsave(Fig4a, file="Fig4a.pdf", dpi=400, height = 6, width = 9)
...
#save plot
ggsave(Fig4b, file="Fig4b.pdf", dpi=400, height = 9, width = 9)
